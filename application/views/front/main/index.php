<div class="w1">
        <div id="wrapper">
            ...
            <header id="header">
                <!-- logo -->
                <strong class="logo">ECOVAS | Live Smart. Enjoy Life.</strong>
                <!-- logotype -->
            ...
            <!-- visual -->
            <div class="visual gradient">
                <div class="heading-holder">
                    <div class="heading">
                        <h1>
                            Try The <em>Revolutionary</em> WINBOT
                            <b>In Your Own Home RISK-FREE for 30 Days!</b>
                        </h1>
                        <div class="note">
                            <p><span>Just 5 easy payments</span></p>
                            <dl>
                                <dt>OF <br>ONLY</dt>
                                <dd><sup>$</sup>79<sup>.99</sup></dd>
                            </dl>
                            <p><span>plus tax and shipping</span></p>
                        </div>
                    </div>
                </div>
                <div class="holder">
                    ...
                    <div class="boxes">
                        ...
                        <div class="box">
                            <!-- info -->
                            <div class="info">
                                <strong class="title">PLUS, Order Right Now &amp; Get <b><span><a href="#">FREE</a></span> BONUS GIFTS!</b></strong>
                                <ul>
                                    <li>3 Free sets of microfiber pads</li>
                                    <li>1 Free cleaning solution 70.5 oz</li>
                                    <li>1 Free extension cord 4'9"</li>
                                    <li>1 Free finishing cloth</li>
                                </ul>
                            </div>
                            <img src="/assets/images/image01.png" width="299" height="220" alt="image description">
                        </div>
                        <!-- box -->
                        <div class="box">
                            <img src="/assets/images/image02.png" width="387" height="284" alt="image description">
                        </div>
                        <!-- box -->
                        <div class="box">
                            <!-- btn-holder -->
                            <div class="btn-holder">
                                <a href="http://ecovacs.local/main/cart" class="button-large" onclick="_gaq.push(['_trackEvent', 'Cart', 'Click', 'Landing Page Get Yours Now']);"><img src="/assets/images/button-large.png" width="329" height="55" alt="GET YOURS NOW!"></a>
            ...
            <div id="main">
                ...
                <div class="threecolumns">
                    ...
                    <article class="column">
                        <div class="frame">
                            <h1><a href="#">Let WINBOT Do the Work!</a></h1>
                            <div class="holder">
                                <div class="image"><img src="/assets/images/img01.png" width="115" height="115" alt="image description"></div>
                                <p>Now you can clean your windows, glass doors, mirrors and more with just the touch of a button. Free yourself from window washing and enjoy life!</p>
                                <a href="#popup1" class="link lightbox">learn more &gt;</a>
                            </div>
                        </div>
                    </article>
                    <!-- column -->
                    <article class="column">
                        <div class="frame">
                            <h1><a href="#">Revolutionary Technology</a></h1>
                            <div class="holder">
                                <div class="image"><img src="/assets/images/img02.png" width="117" height="115" alt="image description"></div>
                                <p>WINBOT automatically determines the size of your window, then programs a path to clean the window quickly and efficiently. </p>
                                <a href="#popup2" class="link lightbox">learn more &gt;</a>
                            </div>
                        </div>
                    </article>
                    <!-- column -->
                    <article class="column alt">
                        <div class="image"><img src="/assets/images/logo-moneyback.png" width="85" height="100" alt="image description"></div>
                        <div class="holder">
                            <h1><a href="#">100% MONEY-BACK <b>GUARANTEE!</b></a></h1>
                            <p>If you are not completely satisfied with your WINBOT, simply send it back for a full refund – <strong>no questions asked!</strong></p>
                            <a href="#popup5" class="link lightbox">learn more &gt;</a>
                        </div>
                    </article>
                </div>
            </div>
            ...
            <footer id="footer">
                ...
                <div class="quotes">
                    <div class="holder">
                        <div class="quote">
                            <img class="img" src="/assets/images/img03.png" width="60" height="60" alt="image description">
                            <blockquote>&ldquo;I don't especially like to clean my windows and mirrors myself, so I let WINBOT do the work!&rdquo;<br />- Christine A.</blockquote>
                        </div>
                        <div class="quote">
                            <img class="img" src="/assets/images/img04.png" width="60" height="60" alt="image description">
                            <blockquote>&ldquo;It makes cleaning windows easy, fast and fun. It makes a boring job much more pleasant.&rdquo;<br />- Kim P.</blockquote>
                        </div>
                        <div class="quote">
                            <img class="img" src="/assets/images/img05.png" width="60" height="60" alt="image description">
                            <blockquote>&ldquo;It’s especially helpful for people who can’t or don’t want to get on a stepstool to clean their windows.&rdquo;<br />- Scott H.</blockquote>
                        </div>
                    </div>
                    <div class="holder">
                        <blockquote class="quote">
                            <q>&ldquo;The robot is aimed at busy homeowners looking for a laborsaving escape from boring chores.&rdquo;</q>
                            <cite>THE WALL STREET JOURNAL</cite>
                        </blockquote>
                        <blockquote class="quote">
                            <q>&ldquo;Window-cleaning robot swipes a chore from to-do list.&rdquo;</q><br />
                            <cite>NBC NEWS</cite>
                        </blockquote>
                        <blockquote class="quote">
